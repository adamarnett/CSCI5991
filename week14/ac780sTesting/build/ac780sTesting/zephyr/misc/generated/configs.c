...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AUXDISPLAY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AUXDISPLAY_INIT_PRIORITY, 85);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AUXDISPLAY_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AUXDISPLAY_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FAKE_ENTROPY_NATIVE_POSIX_SEED_BY_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ENTROPY_HAS_DRIVER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I2C, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I2C_EMUL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EMUL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EMUL_INIT_PRIORITY, 60);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EMUL_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EMUL_LOG_LEVEL, 3);
