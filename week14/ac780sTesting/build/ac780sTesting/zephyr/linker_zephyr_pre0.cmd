...
kscan_driver_api_area : SUBALIGN(4) { _kscan_driver_api_list_start = .; KEEP(*(SORT_BY_NAME(._kscan_driver_api.static.*))); _kscan_driver_api_list_end = .; }
...
ztest :
{
 ...
 emul_area : SUBALIGN(4) { _emul_list_start = .; KEEP(*(SORT_BY_NAME(._emul.static.*))); _emul_list_end = .; }
 symbol_to_keep :
 {
