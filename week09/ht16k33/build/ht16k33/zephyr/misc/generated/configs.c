...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SPARKFUN_QUADALPHA_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SPARKFUN_SERLCD_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AUXDISPLAY_SERLCD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AUXDISPLAY_QUADALPHA, 1);
