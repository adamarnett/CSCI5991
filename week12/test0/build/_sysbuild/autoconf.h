#define SB_CONFIG_BOARD "native_sim"
#define SB_CONFIG_BOARD_REVISION ""
#define SB_CONFIG_BOARD_NATIVE_SIM 1
#define SB_CONFIG_BOARD_NATIVE_SIM_NATIVE 1
#define SB_CONFIG_BOARD_QUALIFIERS "native"
