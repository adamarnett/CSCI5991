...
struct sgp30_data {
    ...
    // tvoc baseline parameter for calibrating tvoc measurements
    // MSB = integer part, LSB = fractional part
    uint16_t tvoc_baseline;
    // co2eq baseline parameter for calibrating co2 measurements
    // MSB = integer part, LSB = fractional part
