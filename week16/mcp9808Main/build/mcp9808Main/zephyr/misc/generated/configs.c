...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_MICROCHIP_MCP9808_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I2C_DUMP_MESSAGES, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCP9808, 1);
